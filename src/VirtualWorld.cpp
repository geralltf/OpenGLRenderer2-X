...
void VirtualWorld::Initilise()
{
	...
	lutTexture00 = Texture::LoadTexture(new std::string("Assets/lut00.tga"))->Anisotropic()->ClampEdges()->Create();
	lutTexture01 = Texture::LoadTexture(new std::string("Assets/lut01.tga"))->Anisotropic()->ClampEdges()->Create();
	lutTexture02 = Texture::LoadTexture(new std::string("Assets/lut02.tga"))->Anisotropic()->ClampEdges()->Create();
	lutTexture03 = Texture::LoadTexture(new std::string("Assets/lut03.tga"))->Anisotropic()->ClampEdges()->Create();
	lutTexture04 = Texture::LoadTexture(new std::string("Assets/lut04.tga"))->Anisotropic()->ClampEdges()->Create();

	cactus = new Character();
	cactus->LoadModel(new std::string("Assets/cactus_v1.obj"));
	cactus->LoadTextures();
	...
	skybox = new Skybox(new std::string("Assets/mp_midnight/midnight-silence_rt.tga"),
		...
		new std::string("Assets/mp_midnight/midnight-silence_up.tga"), 
		new std::string("Assets/mp_midnight/midnight-silence_dn.tga"), 
		new std::string("Assets/mp_midnight/midnight-silence_bk.tga"), 
		new std::string("Assets/mp_midnight/midnight-silence_ft.tga"));
...
void VirtualWorld::Render(sf::RenderWindow* window, Transform* cameraTransform, Matrix4* projectionMatrix, Matrix4* modelview, Vector3f* light_dir, Matrix4* lightModelView)
{
